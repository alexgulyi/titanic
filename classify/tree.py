...
class clfTree(object):
	...
	def __init__(self, featuresNames, targetName, tune):
		"""Creates a classifier with specified parameters in tune"""
		self.clf = tree.DecisionTreeClassifier(splitter = 'best', **tune)
		self.features = featuresNames
		self.target = targetName
		self.parameters = tune
	...
	def predict(self, testData, crossValidate = False):
		...
		if crossValidate:
			...
			score = metrics.accuracy_score(Y, trueY)
